...
import { mergeJSON, removeDuplicateJSON , isJSON } from '../dist/lib';
...
Test('remove duplicates', (t) => {
    t.test('should remove duplicate json', (t) => {
        ...
        t.plan(1);
        t.deepEqual(removeDuplicateJSON(arrs), [ { id: 1, name: 'sravan ganji' }, { id: 2, name: 'anu' }, { id: 4, name: 'mammu' }, { id: 3, name: 'sanju' }, { id: 3, name: 'ram' }, { id: 4, name: 'mammus' }, { id: 4, name: 'sanju' } ])
        t.end();
    });
})
